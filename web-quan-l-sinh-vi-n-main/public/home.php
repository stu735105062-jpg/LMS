...
/* =====================
    1. KẾT NỐI DATABASE
===================== */
// Sử dụng mysqli_report để dễ dàng bắt lỗi nếu có
...
// Nếu không tồn tại User hoặc Role là 'student' thì không cho phép vào trang quản trị
if (!$user || $user['role'] === 'student') {
    // Nếu là sinh viên, chuyển hướng về trang thông tin sinh viên
    if ($user['role'] === 'student') {
        header("Location: ../models/student.php"); // Hoặc file portal của sinh viên
    } else {
        session_destroy();
        header("Location: login.php");
    }
...
/* ===========================
    3. DATA: THỐNG KÊ (Khớp với Database mới)
=========================== */
// Thống kê tổng quan từ các bảng: students, classes, subjects
...
// Data cho biểu đồ cột: Top 10 sinh viên có điểm trung bình cao nhất
...
// Data cho biểu đồ tròn: Tỉ lệ điểm danh từ bảng attendance
        ...
        <div class="admin-section">
            ...
            <li class="nav-item">
                <a class="nav-link" href="permissions.php">
                    <i class="bi bi-shield-lock me-2"></i> Phân quyền người dùng
                </a>
            </li>
        </div>
        <?php endif; ?>
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-4">
            <div class="card p-4 h-100">
                <h6 class="fw-bold mb-4 text-center text-primary"><i class="bi bi-pie-chart me-2"></i>Tỉ lệ điểm danh</h6>
...
<script>
// Logic vẽ biểu đồ Chart.js giữ nguyên như cũ
